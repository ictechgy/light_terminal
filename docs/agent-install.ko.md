...
Source install에서 우선 사용할 현재 release tag: v1.0.33
...
- 이 machine에서 가장 덜 놀라운 package manager를 우선한다.
  ...
  - Rust/Cargo fallback: `cargo install --git https://github.com/ictechgy/light_terminal --tag v1.0.33`
...
- 내 agent workflow에 추천하는 첫 명령. 예:
  ...
  - `lterm agent grok --name grok-main` (`grok` binary가 PATH에 있을 때)
